...
Page({
  data: {
    ...
    menuItems: [
      { id: 'favorites', icon: '♡', label: '我的收藏', desc: '常看的商品' },
      { id: 'addresses', icon: '⌖', label: '收货地址', desc: '管理收货人和地址' },
      { id: 'coupons', icon: '券', label: '优惠券', desc: '可用优惠与领取记录' },
      { id: 'points', icon: '分', label: '积分明细', desc: '查看积分变动' },
      { id: 'help', icon: '?', label: '帮助中心', desc: '常见问题与服务说明' },
      { id: 'about', icon: 'i', label: '关于我们', desc: '品牌与联系方式' },
    ],
  },
